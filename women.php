          ...
          if($result){
            while($obj = $result->fetch_object()) {
              ...
              echo '<strong><p>Items Left '.$obj->qty.'</p></strong>';
                ...
                echo '<p><a href="login.php?action=add&id='.$obj->id.'"><input type="submit" value="Add To Cart" style="clear:both; background:  #e91e63; border: none; color: #fff; font-size: 1em; padding: 8px;" /></a></p>';
