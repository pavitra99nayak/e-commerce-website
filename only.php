...
?>
    ...
    <?php
          ...
          $product_quantity = array();
            ...
            $result=mysqli_query($link,"SELECT * from products where brand='rod'") or die(mysqli_errno());          
            if($result === FALSE){
            die(mysql_error());
          }
          if($result){
            while($obj = $result->fetch_object()) {
              ...
              if($obj->qty > 0){
                echo '<p><a href="update-cart.php?action=add&id='.$obj->id.'"><input type="submit" value="Add To Cart" style="clear:both; background:  #e91e63; border: none; color: #fff; font-size: 1em; padding: 8px;" /></a></p>';
              }
              else {
                echo 'Out Of Stock!';
              }
